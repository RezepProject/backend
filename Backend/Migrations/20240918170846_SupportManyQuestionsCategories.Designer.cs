...
namespace backend.Migrations
{
    ...
    [Migration("20240918170846_SupportManyQuestionsCategories")]
    partial class SupportManyQuestionsCategories
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Entities.QuestionCategory", b =>
                {
                    ...
                    b.HasIndex("QuestionId")
                        .HasDatabaseName("ix_questioncategory_question_id");
            ...
            modelBuilder.Entity("backend.Entities.QuestionCategory", b =>
                {
                    b.HasOne("backend.Entities.Question", null)
                        .WithMany("Categories")
                        .HasForeignKey("QuestionId")
                        .HasConstraintName("fk_questioncategory_question_question_id");
                });
